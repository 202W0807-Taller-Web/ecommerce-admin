      ...
      >
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 py-6 space-y-4 overflow-y-auto">
            {navItems.map((item) => {
              // Para links padres, resaltar si alguna ruta hija está activa
                    ...
                    <div>
                      <button
                        ...
                        className={`flex w-full items-center justify-between px-8 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-100 rounded-md
                          ${(openAccordions.includes(item.label) || isParentActive) ? "bg-gray-100 font-semibold" : ""}`}
                      >
                      ...
                      {(openAccordions.includes(item.label) || isParentActive) && (
                        <div className="ml-6 mt-1 space-y-1">
                          {item.children?.map((child) => {
                            // Resaltar el link hijo si la ruta coincide o es una subruta
